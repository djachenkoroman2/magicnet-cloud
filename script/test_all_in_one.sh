...
# bash script/main_classification.sh cfgs/scanobjectnn/pointnet++.yaml mode=test pretrained_path=$ckpt_pth 
...
# CUDA_VISIBLE_DEVICES=0 bash script/main_classification.sh cfgs/scanobjectnn/pointnet++para.yaml mode=test pretrained_path=$ckpt_pth 
...
# CUDA_VISIBLE_DEVICES=0 bash script/main_classification.sh cfgs/scanobjectnn/pointnext-s.yaml mode=test pretrained_path=$ckpt_pth 
